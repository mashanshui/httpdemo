...
public class HttpRequestUtil {
    public static <T> T getRetrofitClient(String interfaceName, String type) {
        RetrofitConfig<Object> retrofitObject = new RetrofitConfig<>();
        Retrofit requestClient = retrofitObject.getRetrofit(RetrofitConfig.getDefaultRequestConfig(), type);
        T t = null;
        try {
